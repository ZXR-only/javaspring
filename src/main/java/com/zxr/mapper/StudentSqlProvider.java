...
public class StudentSqlProvider {
    ...
    public String insertSelective(Student record) {
        ...
        if (record.get班级() != null) {
            sql.VALUES("班级", "#{班级,jdbcType=CHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.get班级() != null) {
            sql.SET("班级 = #{record.班级,jdbcType=CHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Student record) {
        ...
        if (record.get所在班级() != null) {
            sql.SET("所在班级 = #{所在班级,jdbcType=CHAR}");
        }
